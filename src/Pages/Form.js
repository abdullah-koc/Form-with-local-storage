    ...
    <ThemeProvider theme={darkTheme}>
      <Box classes={classes.box}>
        ...
        <Box className={classes.outerBox}>
          ...
          <Box className={classes.innerBox}>
            <FormControlLabel className={classes.texts}
              control={
                <Switch
            ...
            >
              ...
              >
                <FormControlLabel className={classes.texts}
                  ...
                  label="Female"
                />
                <FormControlLabel className={classes.texts} value="male" control={<Radio color="primary" />} label="Male" />
                <FormControlLabel className={classes.texts}
                  value="other"
                  control={<Radio color="primary" />}
                  label="Other"
        ...
        <Box className={classes.centeredText}>
          <h3>{!isFilled ? "You need to fill both name and surname" : "­"}{copied && "Copied to clipboard"}</h3>
        ...
        <Box className={classes.outerBox}>
          <Box className={classes.innerBox}>
            {rows.length !== 0 && <Button
              ...
              <AiOutlineClear /> Clear Local Storage
            </Button>}
          </Box>
        </Box>
